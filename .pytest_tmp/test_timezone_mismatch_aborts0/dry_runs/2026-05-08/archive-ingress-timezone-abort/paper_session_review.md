...
- Terminal Reason Code: `unsupported_timezone`
- Terminal Reason: Normalized S23 paper events must use Asia/Kolkata.

## Guardrails

- Guardrail Code: `unsupported_timezone`
- Guardrail Message: Normalized S23 paper events must use Asia/Kolkata.
- Blocking Event Type: `SELECTED_CONTRACT_QUOTE`
- Blocking Source ID: `n/a`
- Operator Action Required: Review the recorded paper-session guardrail before retrying.
...
- `2026-05-08T09:30:02+05:30` `WAITING_FOR_RC->ABORTED` `SELECTED_CONTRACT_QUOTE` reason=`event_validation_failed` terminal=`unsupported_timezone` guardrail=`unsupported_timezone`
