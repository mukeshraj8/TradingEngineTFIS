...
## Opening Snapshot (09:16)
- Captured At: `2026-05-28T09:16:00+05:30`
- NIFTY Spot Used: `23780.0`
- Available Checkpoints: `0915`
- Waiting For: `ORPT, RC`
- Current Day High So Far (`CDHH`): `23910.0`
- Current Day Low So Far (`CDLL`): `23882.0`
- Monthly Status Price Used: `23902.0`
...
- Can Finalize Trade Decision: `False`
...
- `ORPT` from `2026-05-28T09:24:00+05:30` to `2026-05-28T09:24:59+05:30`: open `23902.0`, high `23918.0`, low `23890.0`, close `23912.0` -> not available yet
...
- `current` (2026-05 / 2026-W22) @ `2026-05-28T09:14:59+05:30` -> base=`BEAR_CF` normalized=`BEAR_CF` via `BEAR_CF_B_THRESHOLD` (used=`True`)
  Levels: PMH `24900.0`, PML `24580.0`, CMH `24680.0`, CML `23882.0`, PWH `24680.0`, PWL `24220.0`, CWH `24410.0`, CWL `23882.0`, close `23902.0`
...
- `CDHH` = `23910.0` from `derived_from_available_checkpoints`
...
### Final Decision At This Stage
- Final decision could not be produced: `MINIMUM_OI_NOT_MET`
- Reason: `Option-chain candidates in the strike range do not meet minimum OI.`
- Attempted Expiries: `2026-06-04`
- Rejected Candidate Counts: `{'minimum_oi_not_met': 1, 'minimum_premium_not_met': 1, 'option_type_mismatch': 1}`
