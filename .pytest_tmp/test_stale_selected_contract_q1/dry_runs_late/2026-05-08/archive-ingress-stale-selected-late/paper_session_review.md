...
- Terminal Reason Code: `stale_underlying_quote`
- Terminal Reason: Quote age 91s exceeds allowed freshness.

## Guardrails

- Guardrail Code: `stale_underlying_quote`
- Guardrail Message: Quote age 91s exceeds allowed freshness.
- Blocking Event Type: `UNDERLYING_QUOTE`
- Blocking Source ID: `normalized_underlying_quote:nifty`
...
- `2026-05-08T09:31:30+05:30` `DECISION_READY->NO_TRADE` `NONE` reason=`session_readiness_no_trade` terminal=`stale_underlying_quote` guardrail=`stale_underlying_quote`
