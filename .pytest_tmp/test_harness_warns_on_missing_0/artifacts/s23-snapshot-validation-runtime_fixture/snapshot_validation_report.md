...
- Runtime Fixture: `D:\TradingEngineTFISRefactored\.pytest_tmp\test_harness_warns_on_missing_0\runtime_fixture.json`
- Requested Samples: `1`
- Interval Seconds: `0`
...
- Warnings: `MISSING_OI`
- Warning Message: Option-chain candidates are missing OI.
